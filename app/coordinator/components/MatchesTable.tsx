...
import RescheduleMatch from "./RescheduleMatch";
        ...
        <Table className='w-full h-full'>
          <TableHeader className='text-center'>
            <TableRow className='border border-gray-700 '>
              ...
              <TableHead className='text-white'>Table Position</TableHead>
              <TableHead className='text-white'>Opponent Form</TableHead>
